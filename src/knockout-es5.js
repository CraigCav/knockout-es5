...
(function(global, undefined) {
  ...
  // -------------------
  //
  // Custom bindings often need to be provided with the observable rather than the value of the
  // property. This custom binding provider supplies bindings with actual observable values.
  // NOTE: Knockout's built in bindings use its's internal `_ko_property_writers` feature to be able to
  // write back to the property, but custom bindings may not be able to use `_ko_property_writers`
  // unless/until it is exposed.
